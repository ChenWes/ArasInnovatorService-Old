    ...
    public class FabricPartClass
    {
        ...
        public SelectionFilter SelectionFilter
        {
            get
            {
                ...
                {
                    return SelectionFilter.CreateLeaf("cn_class0", "EQ", "FAB");//OK                    
                }
                else
                {
        ...
        private List<Part> _FabricPartList = new List<Part>();
        public List<Part> FabricPartList
        {
            get { return _FabricPartList; }
            set { _FabricPartList = value; }
        }
