...
{
    public class GarmentStyleSizeRange
    {
        ...
        public string CN_SIZE { get; set; }
        public string CN_SIZE_CATEGORY { get; set; }
        public string CN_NOTE { get; set; }

        public List<GarmentStyleSizeRangeD1> GarmentStyleSizeRangeD1List { get; set; }
