...
namespace ArasInnovatorService.ArasModel
{
    public class GarmentBOMPart
    {
        ...
        public string CN_BOM_SPEC { get; set; }
        public string CN_GMT_COMP { get; set; }
        public string CN_CUTWAY { get; set; }
        public string CN_FAB_WIDTH { get; set; }
        public string CN_CMB_NAME { get; set; }
        public float CN_YPD { get; set; }
        public string CN_GARMENT { get; set; }
        public string CN_YEARSEASON { get; set; }
