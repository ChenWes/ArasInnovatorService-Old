...
{
    public class GarmentStyleColorWay
    {
        ...
        public string CN_CW_CODE { get; set; }
        public string CN_PLU { get; set; }
        public string CN_CUST_CW { get; set; }
        public string CN_CUST_CWCODE { get; set; }
        public string CN_YEARSEASON { get; set; }
        public string CN_LINE { get; set; }
        public string CN_BODY_PATTERN { get; set; }
    }
}