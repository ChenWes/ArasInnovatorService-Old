...
{
    public class GarmentStyleClass
    {
        private int _iDisplayPageIndex = 1;
        ...
        private int _iDisplayPageSize = 20;
        ...
        private List<Garment> _GarmentStyleList = new List<Garment>();
        public List<Garment> GarmentStyleList
        {
            get { return _GarmentStyleList; }
            set { _GarmentStyleList = value; }
        }
